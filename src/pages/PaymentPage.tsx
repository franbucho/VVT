    ...
    return (
        <PageContainer title={t('payment_title')} className="max-w-lg mx-auto">
            <div className="bg-card-bg p-8 rounded-xl shadow-2xl text-center">
                ...
                <h2 className="text-2xl font-bold mb-2 text-primary-dark">{t('payment_unlock_title')}</h2>
                <p className="text-primary-dark/80 mb-6">{t('payment_unlock_description')}</p>
                
                <div className="my-6 p-4 bg-accent/10 rounded-lg">
                    <div className="text-5xl font-extrabold text-accent">$10.00 <span className="text-lg font-normal text-primary-dark/60">USD</span></div>
                    <p className="text-sm text-primary-dark/60 mt-1">One-time payment</p>
                </div>
