...
export const es: TranslationKeys = {
  ...
  our_tech_step2_desc: "La imagen, junto con los datos de salud contextuales, se envía a nuestro backend seguro y es analizada por nuestro modelo de IA patentado.",
  ...
  our_tech_tech1_desc: "En nuestro núcleo se encuentra un sofisticado modelo de IA patentado, entrenado para reconocer patrones visuales asociados con diversos indicadores de salud ocular. Aprende continuamente para mejorar su precisión.",
