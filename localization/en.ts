export const en = {
  ...
  home_ctaButton_free: "Start Your Free Analysis",
  ...
  auth_orDivider: "OR",
  auth_areYouADoctor: "Are you a medical professional?",
  auth_registerAsDoctorLink: "Register here.",
  auth_doctorRegistrationTitle: "Medical Professional Registration",
  auth_not_a_doctor: "Not a doctor?",
  auth_register_as_user_link: "Register as a user.",
  auth_doctor_signup_success: "Registration successful! Your request has been sent for admin approval.",

  doctor_specialty_label: "Specialty",
  doctor_specialty_placeholder: "e.g., Ophthalmology",
  doctor_license_label: "Medical License Number",
  doctor_license_placeholder: "e.g., 123456789",
  doctor_graduationYear_label: "Graduation Year",
  doctor_graduationYear_placeholder: "e.g., 2010",
  doctor_country_label: "Country",
  doctor_country_placeholder: "e.g., United States",
  doctor_state_label: "State/Province",
  doctor_state_placeholder: "e.g., California",
  doctor_city_label: "City",
  doctor_city_placeholder: "e.g., San Francisco",
  ...
  profile_reminders_title: "My Reminders",
  ...
  profile_reminders_none: "You have no active reminders.",
  profile_reminders_add_new: "Add New Reminder",
  
  reminder_modal_title_add: "Add a New Reminder",
  reminder_modal_title_edit: "Edit Reminder",
  reminder_type: "Reminder Type",
  reminder_type_medication: "Medication",
  reminder_type_consultation: "Consultation",
  reminder_name_label: "Name / Title",
  reminder_name_placeholder_medication: "e.g., Latanoprost Eye Drops",
  reminder_name_placeholder_consultation: "e.g., Follow-up with Dr. Smith",
  reminder_details_label: "Details / Dosage",
  reminder_details_placeholder_medication: "e.g., 1 drop in each eye",
  reminder_details_placeholder_consultation: "e.g., Check on glaucoma progress",
  reminder_frequency_label: "Frequency",
  reminder_frequency_helper: "Remind me every...",
  reminder_frequency_hours: "Hour(s)",
  reminder_frequency_days: "Day(s)",
  reminder_frequency_weeks: "Week(s)",
  reminder_frequency_months: "Month(s)",
  reminder_starts_at_label: "First Reminder Time",
  reminder_save_button: "Save Reminder",
  reminder_delete_button: "Delete",
  reminder_next_due: "Next due:",
  reminder_notification_permission_title: "Enable Notifications",
  reminder_notification_permission_body: "To receive reminders, please allow Niria to send you notifications.",
  reminder_notification_denied: "Notifications are blocked. Please enable them in your browser settings to receive reminders.",
  reminder_notification_medication_title: "Medication Reminder",
  reminder_notification_consultation_title: "Consultation Reminder",
  ...
  admin_tab_doctor_requests: "Doctor Requests",
  admin_doctor_requests_title: "Pending Doctor Approvals",
  admin_no_doctor_requests: "There are no pending doctor requests.",
  ...
  pricing_subtitle: "Simple, transparent pricing for every need.",
  pricing_plan_individual_title: "Individual Analysis",
  pricing_plan_individual_price: "$3.99",
  pricing_plan_individual_frequency: "One-time payment",
  pricing_plan_individual_feature1: "AI-Powered Analysis",
  pricing_plan_individual_feature2: "Downloadable PDF Report",
  pricing_plan_individual_feature3: "List of Nearby Specialists",
  pricing_cta_get_started: "Get Started",
  pricing_plan_plus_title: "Wellness Pack",
  pricing_plan_plus_price: "$4.99",
  pricing_plan_plus_frequency: "One-time payment",
  pricing_plan_plus_feature1: "Everything in Individual",
  pricing_plan_plus_feature2: "Includes 2 evaluations",
  pricing_cta_choose_plus: "Choose Pack",
  pricing_plan_business_title: "Niria for Business",
  pricing_plan_business_price: "Custom",
  pricing_plan_business_frequency: "Annual Billing",
  pricing_plan_business_feature1: "Bulk evaluations for employees",
  pricing_plan_business_feature2: "HR Admin Dashboard",
  pricing_plan_business_feature3: "Employee wellness tracking",
  pricing_plan_business_feature4: "Priority support",
  pricing_cta_contact_sales: "Contact Sales",
  pricing_best_value: "Best Value",

  // Our Technology Page
  our_tech_title: "Our Technology",
  our_tech_subtitle: "Discover the innovation powering Niria's intelligent eye health analysis.",
  our_tech_how_it_works_title: "How It Works: A Simple Four-Step Process",
  our_tech_step1_title: "1. Capture",
  our_tech_step1_desc: "The user takes a clear, well-lit photo of their eye using their smartphone camera through our guided interface.",
  our_tech_step2_title: "2. Analyze",
  our_tech_step2_desc: "The image, along with contextual health data, is sent to our secure backend and analyzed by our proprietary AI model.",
  our_tech_step3_title: "3. Report",
  our_tech_step3_desc: "In minutes, the system generates a preliminary, easy-to-understand report highlighting potential areas of concern and providing personalized health tips.",
  our_tech_step4_title: "4. Connect",
  our_tech_step4_desc: "Based on the analysis and the user's location, we provide a list of nearby ophthalmologists to facilitate the next step towards professional care.",
  our_tech_key_technologies_title: "Key Technologies",
  our_tech_tech1_title: "AI & Machine Learning",
  our_tech_tech1_desc: "At our core is a sophisticated, proprietary AI model trained to recognize visual patterns associated with various eye health indicators. It continuously learns to improve its accuracy and insights.",
  our_tech_tech2_title: "Secure Cloud Infrastructure",
  our_tech_tech2_desc: "Our platform is built on a scalable and secure cloud infrastructure, ensuring high availability, rapid processing, and data integrity for every user, no matter where they are.",
  our_tech_tech3_title: "Data Privacy & Compliance",
  our_tech_tech3_desc: "We prioritize user privacy with end-to-end encryption and adhere to strict data protection standards. Your health information is anonymized and handled with the utmost confidentiality.",
  our_tech_integration_title: "Integration Possibilities",
  our_tech_integration_subtitle: "Niria is designed to be a flexible and powerful tool. We offer partnership opportunities to integrate our technology into your platform.",
  our_tech_integration1_title: "Telemedicine Platforms",
  our_tech_integration1_desc: "Enhance your virtual consultations with our initial screening tool to better prioritize and guide patients.",
  our_tech_integration2_title: "Corporate Wellness Programs",
  our_tech_integration2_desc: "Offer a proactive health benefit to your employees, helping to detect potential issues early and promote well-being.",
  our_tech_integration3_title: "Healthcare Providers",
