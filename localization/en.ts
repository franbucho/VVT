export const en = {
  ...
  header_hrAdminPanel: "HR Admin Panel",
  ...
  profile_error_upload: "Failed to upload photo.",
  ...
  profile_placeholder_doctor: "e.g., Dr. Smith",
  ...
  admin_stats_admins: "Administrators",
  ...
  hr_admin_dashboard_placeholder: "The dashboard with team statistics, alerts, and evaluation tracking is coming soon.",
  ...
  hr_dashboard_evaluations_pending: "Pending First Eval",
  hr_dashboard_evaluations_due_soon: "Due Soon",
  hr_dashboard_evaluations_overdue: "Overdue",
  hr_dashboard_team_members_title: "Team Members Status",
  ...
  error_image_processing: "Failed to process the image. Please try again.",
