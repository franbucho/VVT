export const en = {
  ...
  q_option_none_of_the_above: "None of the above",
  ...
  q1_reason_blurry_vision: "Blurry or altered vision",
  q1_reason_tired_eyes: "Tired or fatigued eyes",
  q1_reason_redness_irritation: "Redness or irritation",
  q1_reason_periodic_checkup: "Periodic check-up",
  q1_reason_other: "Other",
  ...
  questionnaire_screenTime: "7. On average, how many hours a day do you spend in front of screens (computer, phone, tablet, etc.)?",
  screen_time_less_than_2: "Less than 2 hours",
  screen_time_2_4: "2-4 hours",
  screen_time_4_8: "4-8 hours",
  screen_time_more_than_8: "More than 8 hours",

  questionnaire_occupationalHazards: "8. Are you exposed to any of the following occupational hazards at work?",
  hazards_oil_gas: "Oil or gas industry",
  hazards_mining: "Mining",
  hazards_agro: "Agro-industry (animal husbandry, etc.)",
  hazards_chemicals: "Exposure to chemicals (pools, labs, etc.)",
  hazards_outdoor_elements: "Exposure to external elements (diving, lifeguards, etc.)",
  hazards_none: "None of the above",
  
  validation_name_required: "Please enter your first and last name.",
  validation_dob_required: "Please select your complete date of birth.",
  validation_reason_required: "Please select at least one reason for the evaluation.",
  ...
  report_submitted_image: "Submitted Eye Image",
  ...
  date_locale: "en-US",
  questionnaire_screenTime_label: "Daily Screen Time",
  questionnaire_occupationalHazards_label: "Occupational Hazards",
  report_page2_header: "Detailed Analysis & Questionnaire",
  ...
  error_generic_api_timeout: "The AI service took too long to respond. This may be due to a slow network connection. Please try again.",
  error_image_processing: "Failed to process the uploaded image. Please ensure it's a valid image file and try again.",
