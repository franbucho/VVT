export const en = {
  ...
  our_tech_step2_desc: "The image, along with contextual health data, is sent to our secure backend and analyzed by our AI model, powered by Google's Gemini.",
  ...
  our_tech_tech1_desc: "At our core is a sophisticated AI model, built on Google's Gemini, trained to recognize visual patterns associated with various eye health indicators. It continuously learns to improve its accuracy and insights.",
